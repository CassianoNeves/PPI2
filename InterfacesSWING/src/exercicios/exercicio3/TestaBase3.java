...
public class TestaBase3 extends Base3{
	...
	public TestaBase3(){
		...
		container.add( lblCodigo = getJTextField(60) );
		container.add( getJLabel( 50, "Nome:" ) );
		container.add( lblNome = getJTextField(230) );
		...
		container.add( cbEstados = getJComboBox(120, estados));
