...
public class Base3 extends JFrame{
	...
	public JComboBox getJComboBox( int coluna, int linha, int cbLargura, ArrayList<String> estados ){
	...
	public JComboBox getJComboBox( int cbLargura, ArrayList<String> estados ) {
		
		return ( getJComboBox( coluna, linha, cbLargura, estados ) );
